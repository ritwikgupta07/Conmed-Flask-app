...
ELEVENLABS_API_KEY = ELEAPI
# ELEVENLABS_API_KEY = "21m00Tcm4TlvDq8ikWAM"
ELEVENLABS_VOICE_STABILITY = 0.1
ELEVENLABS_VOICE_SIMILARITY = 0.8

# Choose your favorite ElevenLabs voice
# ELEVENLABS_VOICE_NAME = "Lotus Herbal Support"
ELEVENLABS_VOICE_NAME = "Conmed Support"
...
def generate_reply(conversation: list) -> str:
    ...
    response = openai.ChatCompletion.create(
        ...
        messages=[
            {
                "role": "system",
                "content": "Welcome to Conmed Technical Support! I’m here to assist you with any questions or issues you might be facing. I understand that dealing with technical problems can be frustrating, and I want to ensure you feel supported throughout this process. Please share the details of your concern, and together we’ll work towards a solution that meets your needs. Response should be strictly less than 100 word",
            },
        ]
        + conversation,
    )
...
def index():
    ...
    return render_template(r"index.html", voice=ELEVENLABS_VOICE_NAME)
